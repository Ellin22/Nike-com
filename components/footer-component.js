class Footer extends HTMLElement {
    connectedCallback(){
        ...
        <div class=" w-full flex flex-col  flex-wrap justify-between pt-[40px] px-[40px] min-[600px]:flex-row">
            <div>
                <ul class="text-white text-sm mb-[12px]">
                    <li class="mb-[20px]"><a href="#">RESOURCES</a></li>
                    <li class="mb-[20px]"><a href="#">GITF CARDS</a></li>
                    <li class="mb-[20px]"><a href="#">FIND A STORE</a></li>
                    <li class="mb-[20px]"><a href="#">BECOME A MEMBER</a></li>
                    <li class="mb-[20px]"><a href="#">NIKE X NBA</a></li>
                    <li class="mb-[20px]"><a href="#">NIKE JOURNAL</a></li>
                    <li class="mb-[20px]"><a href="#">Site Feedback</a></li>
                </ul>
            </div>

            <div>
                <h4 class="text-white text-sm mb-[12px]"><a href="#">Help</a></h4>
                <ul class="text-xs text-gray-400">
                    <li class="mb-[20px]"><a href="#">Get Help</a></li>
                    <li class="mb-[20px]"><a href="#">Order Status</a></li>
                    <li class="mb-[20px]"><a href="#">Shipping and Delivery</a></li>
                    <li class="mb-[20px]"><a href="#">Returns</a></li>
                    <li class="mb-[20px]"><a href="#">Order Cancaellation</a></li>
                    <li class="mb-[20px]"><a href="#">Payment Options</a></li>
                    <li class="mb-[20px]"><a href="#">Gift Card Balance</a></li>
                    <li class="mb-[20px]"><a href="#">Contact Us</a></li>
                </ul>
            </div>

            <div>
                <h4 class="text-white text-sm mb-[12px]"><a href="#">Company</a></h4>
                <ul class=" text-gray-400 text-xs">
                    <li class="mb-[20px]"><a href="#">About Nike</a></li>
                    <li class="mb-[20px]"><a href="#">News</a></li>
                    <li class="mb-[20px]"><a href="#">careers</a></li>
                    <li class="mb-[20px]"><a href="#">Investors</a></li>
                    <li class="mb-[20px]"><a href="#">Purpose</a></li>
                    <li class="mb-[20px]"><a href="#">Sustainability</a></li>
                </ul>
            </div>

            <div>
                <h4 class=" text-white text-sm mb-[12px]"><a href="#">PROMOTIONS & DISCOUNTS</a></h4>
                <ul class=" text-gray-400 text-xs ">
                    <li class="mb-[20px]"><a href="#">Student</a></li>
                    <li class="mb-[20px]"><a href="#">Military</a></li>
                    <li class="mb-[20px]"><a href="#">Teacher</a></li>
                    <li class="mb-[20px]"><a href="#">First Responders & Medical</a></li>
                    <li class="mb-[20px]"><a href="#">Professionals</a></li>
                    <li class="mb-[20px]"><a href="#">Birthday</a></li>
                </ul>
            </div> 
